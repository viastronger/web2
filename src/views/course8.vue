<template>
  <div class="img-placeholder">
    <img v-scrollBot src="@/assets/images/course8/01.png" alt="" />

    <div class="banner-box banner-box1">
      <img v-scrollBot src="@/assets/images/course8/02.png" alt="" />
    ...
    <div class="banner-box banner-box2">
      <img v-scrollBot src="@/assets/images/course8/03.png" alt="" />
...
import bannerList1 from "@/assets/images/course8/banner1";
import bannerList2 from "@/assets/images/course8/banner2";
