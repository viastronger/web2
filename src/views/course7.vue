<template>
  <div class="img-placeholder">
    <img v-scrollBot src="@/assets/images/course7/01.png" alt="" />

    <div class="banner-box banner-box1">
      <img v-scrollBot src="@/assets/images/course7/02.png" alt="" />
    ...
    <div class="banner-box banner-box2">
      <img v-scrollBot src="@/assets/images/course7/03.png" alt="" />
...
import bannerList1 from "@/assets/images/course7/banner1";
import bannerList2 from "@/assets/images/course7/banner2";
